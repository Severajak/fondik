const prepareBranding = () => {
  document.body.insertAdjacentHTML('afterbegin', '<div id="ssp-branding-118559"></div>');
...
const handleResponse = (advert, data) => {
  if (advert.width === 2000) {
    ...
    const dropDown = [document.querySelector('.dropdown-section-1'), document.querySelector('.dropdown-section-2'), document.querySelector('.dropdown-section-3')];
